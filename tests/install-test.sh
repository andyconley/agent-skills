...
for runtime in "$TEST_ROOT/codex" "$TEST_ROOT/claude"; do
  ...
  for asset in epic-v1.md epic-v2.md story-v1.md story-v2.md story-v3.md task-v1.md task-v2.md spike-v1.md spike-design-v2.md spike-investigation-v2.md spike-design-v3.md spike-investigation-v3.md; do
